...
namespace NewBess
{
    ...
    class ParticipantViewModel : ObservableObject, IPageViewModel
    {
        ...
        private void Save()
        {
            ...
            _xmlDoc.Save(@"C:\Users\anton\source\repos\NewBess\NewBess\bin\x64\Debug\Participants.xml");

            if (_operation == "Create" || _operation == "Edit")
            {
                var xDoc = XDocument.Load(@"C:\Users\anton\source\repos\NewBess\NewBess\bin\x64\Debug\Participants.xml");
                var newxDoc = new XElement("Participants", xDoc.Root
                    .Elements()
                    .OrderBy(x => (int)x.Attribute("Id")));

                newxDoc.Save(@"C:\Users\anton\source\repos\NewBess\NewBess\bin\x64\Debug\Participants.xml");
            }
        ...
        private void LoadParticipants()
        {
            if (!_loaded)
            {
                ...
                string filename = @"C:\Users\anton\source\repos\NewBess\NewBess\bin\x64\Debug\Participants.xml";
